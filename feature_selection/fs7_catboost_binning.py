...
FEATURES_ALREADY_FOUND = [
    "bins_Duration_15_uniform",  # -0.05954 -> take
    # 'bins_Body_Temp_9_quantile',  # 0.05957 - don't
    # 'bins_Height_11_quantile',  # 0.05961 -> don't
]
...
def score_dataset(
    ...
    params_catboost = {
        "loss_function": "RMSE",
        "learning_rate": 0.20,  # 0.20 -> ca. 12 secs
    }
...
df_results.to_excel(PATH_CACHE / "df_results_fs7.xlsx", index=False)
