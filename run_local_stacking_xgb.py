...
df_test_predictions_from_oof["pred"].to_pickle(PATH_CACHE / f"{filename_prefix}_test.pkl")
df_test_predictions_from_full["pred"].to_pickle(PATH_CACHE / f"{filename_prefix}_test_from_full.pkl")
