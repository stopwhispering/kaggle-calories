...
# copied from https://www.kaggle.com/code/yunusemreakca/s5e5-calories-prediction/notebook
...
train, test = cap_outliers_iqr(df_train, df_test, ["Height", "Weight", "Heart_Rate", "Body_Temp"])
