...
# https://wandb.ai/stopwhispering314/calories/runs/yizkutbm/logs
params_xgb = {'colsample_bytree': 0.4993498725654075,
              'eta': 0.5308562698849296,
              'gamma': 5.126859862343647e-05,
              'learning_rate': 0.012567569137235089,
              'max_delta_step': 0,
              'max_depth': 4,
              'min_child_weight': 46,
              'reg_alpha': 3.5661576544401033e-06,
              'reg_lambda': 2.871017008842648e-07,
              'subsample': 0.8162965216784338}
