...
new_features = ['Duration_x_Heart_Rate', 'Duration_x_Body_Temp', 'Height_x_Duration', 'Heart_Rate_x_Body_Temp', 'Weight_x_Duration', 'Age_x_Duration', 'Height_x_Heart_Rate', 'Weight_x_Heart_Rate', 'Age_x_Heart_Rate', 'Height_x_Body_Temp']
