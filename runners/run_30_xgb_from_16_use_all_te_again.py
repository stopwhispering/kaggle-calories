...
from calories.constants import PATH_TRAIN, PATH_TEST, PATH_PREDS_FOR_ENSEMBLES, PATH_FEATURES, \
    PATH_ORIGINAL, PATH_FEATURES_BY_FOLD
...
nested_features_by_outer_fold: list[
    ...
    tuple[pd.DataFrame, pd.DataFrame, pd.DataFrame]] = feature_store.read_features_by_fold(
    agg='mean',
)
...
trainer = XGBTrainer(
    params={"random_state": 42, "verbosity": 0, "n_estimators": 25_000, "early_stopping_rounds": 150} | params_xgb,  #
