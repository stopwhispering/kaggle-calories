...
trainer = CatBoostTrainer(
    params={"random_state": 42, "n_estimators": 6000,
            # "verbose": -200,
            "verbose": 100,
            "early_stopping_rounds": 50} | params_catboost,
...
df_test_predictions_from_oof["pred"] = df_test_predictions_from_oof["pred"] * df_test["Duration"]
df_oof_predictions["pred"] = df_oof_predictions["pred"].clip(1.0, 314.0)
df_test_predictions_from_oof["pred"] = df_test_predictions_from_oof["pred"].clip(1.0, 314.0)
...
df_test_predictions_from_full["pred"] = df_test_predictions_from_full["pred"] * df_test["Duration"]
df_test_predictions_from_full["pred"] = df_test_predictions_from_full["pred"].clip(1.0, 314.0)
