...
# https://wandb.ai/stopwhispering314/calories/runs/nu5kgs1l/logs
params_lgbm = {
    'bagging_freq': 6,
    'colsample_bytree': 0.472975970791126,
    'extra_trees': True,
    'learning_rate': 0.008804488376504327,
    'max_depth': 19,
    'min_child_samples': 146,
    'min_data_in_leaf': 61,
    'num_leaves': 45,
    'reg_alpha': 0.1065234216295912,
    'reg_lambda': 4.515205408051481,
    'subsample': 0.8124649683825889,
    'subsample_for_bin': 225600
}
